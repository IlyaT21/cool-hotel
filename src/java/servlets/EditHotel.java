...
public class EditHotel extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean updateSuccessful = updateHotelInDatabase(id, naziv, user_id);
    ...
    private boolean updateHotelInDatabase(int id, String naziv, int user_id) {
        ...
        try {
            ...
            String sql = "UPDATE hotel SET naziv=?, user_id=? WHERE id=?";
