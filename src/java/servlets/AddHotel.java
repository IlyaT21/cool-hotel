...
public class AddHotel extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean addSuccessful = addHotelToDatabase(naziv, user_id);
    ...
    private boolean addHotelToDatabase(String naziv, String user_id) {
        ...
        try {
            ...
            String sql = "INSERT INTO hotel (naziv, user_id) VALUES (?, ?)";
